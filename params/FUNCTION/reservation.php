...
if (strtotime($debut) <= strtotime($fin) && strtotime($debut) > time()) {
    if ((strtotime($fin) - strtotime($debut)) <= (7 * 86400)) {
        ...
        if (verifDispo($bdd, $idBorne, $debut, $fin) == 0) {
            ...
            $ORes->execute($tab);
            echo "Pour valider votre commande, veuillez procéder au payement en "; ?><a href="index.php?page=indexpanier&id=<?php echo $idBorne; ?>&qtt=1"><button class="dropbtn">cliquant ici</button></a> <?php
                                                                                                                                                                                                            }
                                                                                                                                                                                                        }
                                                                                                                                                                                                    }
                                                                                                                                                                                                                ?>
