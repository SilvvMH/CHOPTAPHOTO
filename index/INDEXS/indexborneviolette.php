...
<body>
    ...
    <div class="container">
        <?php
                $req = "SELECT name, price, quantité, codepromo, description FROM products WHERE id=4";
                $ORes = $bdd->query($req);
                while($produit = $ORes->fetch())
                {
        ?>
      <img class="imageproduit" src="img/bornviolet.png">
    ...
    <div class="livraison">
                ...
                <div class="dropdown" style="float:left;">
                  <a href="index.php?page=reservation&idBorne=4"><button class="dropbtn">commander</button></a>
                </div>
                <br>
                <br>
    </div> 
