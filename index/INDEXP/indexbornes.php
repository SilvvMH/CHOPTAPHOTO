...
<div class="containercouleur">
    ...
    <figure class="snip0016">
        ...
        <figcaption>
            ...
            <a href="index.php?page=indexbornesnoir"></a>
        </figcaption>
    </figure>
    <!-- /borne rouge-->
    ...
    <figure class="snip0016">
        ...
        <figcaption>
            <h2>En Rouge :</h2>
            <p>Les locations de borne vous couteront 150€/24h par borne et elles sont livrées avec une housse et les câbles qui vont avec. Un service technique est disponnible 24h/24 7j/7 si pendant votre location un problème survient.</p>
            <a href="index.php?page=indexbornesrouge"></a>
        </figcaption>
    </figure>
    <!-- /borne noir-->
...
<div class="containerreseaux flex-mob-col">
    <div class="presentationtextreseaux">
        ...
        <!------------BOUTON RESERVER------------>
        <div>
            <a href="index.php?page=indexpanier&id=16&qtt=1">
    ...
    <div class="presentationimagereseaux"><img src="img/bornreseaux.png"></div>
</div>
<!--------------------bornes réseaux sociaux----------------->
...
<!--div container-->
<div class="containercouleur flex-mob-col">
    <!--div container-->
    ...
    <figure class="snip00161">
        ...
        <figcaption>
            ...
            <a href="index.php?page=indexbornesjaune"></a>
        </figcaption>
    </figure>
    <!-- /borne jaune-->
    ...
    <figure class="snip00161">
        ...
        <figcaption>
            <h2>En Bleue :</h2>
            <p>Les locations de borne vous couteront 80€/24h par borne. Un service technique est disponnible 24h/24 7j/7 si pendant votre location un problème survient. (intervention sous 5h)</p>
            <a href="index.php?page=indexbornesbleu"></a>
        </figcaption>
    </figure>
    <!-- /borne bleu-->
    ...
    <figure class="snip00161">
        ...
        <figcaption>
            <h2>En Rose :</h2>
            <p>Les locations de borne vous couteront 80€/24h par borne. Un service technique est disponnible 24h/24 7j/7 si pendant votre location un problème survient. (intervention sous 5h)</p>
            <a href="index.php?page=indexbornesviolette"></a>
        </figcaption>
    </figure>
    ...
    <figure class="snip00161">
        ...
        <figcaption>
            <h2>En Blanche :</h2>
            <p>Les locations de borne vous couteront 80€/24h par borne. Un service technique est disponnible 24h/24 7j/7 si pendant votre location un problème survient. (intervention sous 5h)</p>
            <a href="index.php?page=indexbornesblanche"></a>
        </figcaption>
    </figure>
...
<div class="container1 flex-mob-col" id="anniv">
    <div class="presentationtext">
        ...
        <!--------BOUTON RESERVER-------->
        <div>
            <A href="index.php?page=indexpanier&id=17&qtt=1">
                <button type="button" class="btn btn-primary">Réserver</button>
            </A>
        </div>
        <!--------BOUTON RESERVER-------->
    ...
    <div class="presentationimage"><img src="img/bornannivsilv.png"></div>
</div>
<!-------------------------bornes anniversaires--------------------->
...
<div class="texteconnectivite">
    <p>
    <h2 id="entreprise" class="titretextconnect">VOUS ETES UN ENTREPRENEUR ?<br>VOUS VOULLEZ FAIRE VOTRE PUB ?<br>CETTE BORNE ATTIRE LES LIKES ET LES PARTAGES !</h2>
...
<div class="container2borne flex-mob-col" id="container2">
    ...
    <div class="presentationtext2borne">
        ...
        <br>
        <br>
        <a href="index.php?page=indexpanier&id=18&qtt=1">
